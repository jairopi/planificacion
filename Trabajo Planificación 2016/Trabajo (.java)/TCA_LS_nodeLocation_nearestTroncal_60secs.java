...
public class TCA_LS_nodeLocation_nearestTroncal_60secs implements IAlgorithm
{
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		//Tengo que buscar los 40 nodos más cercanos
		...
		// Cojo los  nodostrocales más cercanos
		...
		//Para cada nodo troncal cojo los nodos de acceso más cercanos
		int k = 0;
		...
		/*
		 *	AHORA COMENZAMOS LA ITERACIÓN HASTA 6O SECS 
		 * 
		 */
		...
		while(System.nanoTime()<algorithmEndTime){
			...
			//System.out.println(" En la iteración " + h + " cominenzo en el nodo: " + newRandom);
			...
			//System.out.println("Para la iteración " + h + " El newcoste de los nodo es: " +  newNodosTroncales.size()*coreNodeCost);
			//System.out.println("Para la iteración " + h + " Los newkilómetros totales de Core con enlaces son: " + newTotalKm);
			//System.out.println("Para la iteración " + h + " Los newkilómetro de unir todos los troncales es: " + newTotalKmTroncales );
			//System.out.println("Para la iteración " + h + " El newcoste total de todo es : " + newTotalCost );
		...
		//Añado los enlaces además de devolver el coste
